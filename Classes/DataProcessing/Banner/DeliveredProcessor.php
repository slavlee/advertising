...
namespace Slavlee\Advertising\DataProcessing\Banner;
...
class DeliveredProcessor implements DataProcessorInterface
{
	...
	public function process (ContentObjectRenderer $cObj, array $contentObjectConfiguration, array $processorConfiguration, array $processedData) : array
	{
		...
		if ($cObj->data['CType'] == 'advertising_banner')
		{
			// Track delivery
			// I disable it, because it is incurate. Due cache the processor is not guaranteed
			// to be called on every request
// 			$objectManager = GeneralUtility::makeInstance(ObjectManager::class);
// 			$campaignStatisticService = $objectManager->get(\Slavlee\Advertising\Service\Campaign\StatisticService::class);
