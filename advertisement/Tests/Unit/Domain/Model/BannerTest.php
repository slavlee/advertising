...
{
    /**
     * @var \Slavlee\Advertisement\Domain\Model\Banner|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        $customerFixture = new \Slavlee\Advertisement\Domain\Model\Customer();
    ...
    {
        $zone = new \Slavlee\Advertisement\Domain\Model\Zone();
