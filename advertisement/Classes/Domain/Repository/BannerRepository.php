...
class BannerRepository extends BaseRepository
{
	 ...
	 */
	public function findFromActiveCampaignsForZone(\Slavlee\Advertisement\Domain\Model\Zone $zone): \Doctrine\DBAL\ForwardCompatibility\Result
	{
		$now = new \DateTime();
