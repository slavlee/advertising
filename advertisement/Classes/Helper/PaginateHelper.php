...
namespace Slavlee\Advertisement\Helper;
...
class PaginateHelper
{
	...
	public function getPaginationBar(): array
	{
		...
		if ($this->start == 1)
		{
			$previous = ['step' => 1, 'disabled' => true, 'current' => false, 'label' => LocalizationUtility::translate('pagination.previous', 'advertisement')];
		}else
		{
			$previous = ['step' => $this->currentStep-1, 'disabled' => $this->currentStep <= $this->start, 'current' => false, 'label' => LocalizationUtility::translate('pagination.previous', 'advertisement')];
		}
		...
		{
			$next = ['step' => $this->end, 'disabled' => true, 'current' => false, 'label' => LocalizationUtility::translate('pagination.next', 'advertisement')];
		}else
		{
			$next = ['step' => $this->currentStep+1, 'disabled' => $this->currentStep >= $this->end, 'current' => false, 'label' => LocalizationUtility::translate('pagination.next', 'advertisement')];
		}
