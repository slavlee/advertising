...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:advertising/Resources/Private/Language/locallang_db.xlf:tx_advertising_domain_model_bannerstatistic',
        'label' => 'delivered',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'delivered' => [
            'exclude' => false,
            'label' => 'LLL:EXT:advertising/Resources/Private/Language/locallang_db.xlf:tx_advertising_domain_model_bannerstatistic.delivered',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'banner' => [
            'exclude' => false,
            'label' => 'LLL:EXT:advertising/Resources/Private/Language/locallang_db.xlf:tx_advertising_domain_model_bannerstatistic.banner',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'campaign' => [
            'exclude' => false,
            'label' => 'LLL:EXT:advertising/Resources/Private/Language/locallang_db.xlf:tx_advertising_domain_model_bannerstatistic.campaign',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
